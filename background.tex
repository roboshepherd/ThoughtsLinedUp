...
%% TABLE: COMM-CLASSES
\begin{table}
\caption{General characteristics of common communication strategies}
...
& modifies the environment. & communications are commonly\\
...
& modify the environment &  are  most commonly used forms. \\
& and convey information &  Global broadcast typically  occurs \\
& to others. & to handle emergency situations. \\
& & All communications are local and\\
...
\label{fig:bio-comm-ants-active-space}  % Give a unique label
\end{figure}
...
\label{fig:bio-comm-strategies}  % Give a unique label
\end{figure}
%%
\begin{figure}
\centering
...
\label{fig:bio-comm-strategies-peers}  % Give a unique label
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%
\begin{table}
