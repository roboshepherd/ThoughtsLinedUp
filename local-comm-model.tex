...
%%%%%%%%%%%%%%%%%%%%%
\section{A locality-based peer-to-peer communication model}
...
\begin{figure}
\centering
\subfloat[Series C]{\includegraphics[width=6cm, height=4.5cm]
{images/local-500cm/DeltaTranslationStat.eps}}
%figure caption is below the figure
\subfloat[Series D]{\includegraphics[width=7cm, height=5cm]{images/local-1m/DeltaTranslationStat.eps}}
...
\begin{figure}
\centering
\subfloat[Series C]{\includegraphics[height=5cm]
{images/local-500cm/Local-500cm-SignalingFreqStat.eps}}
\subfloat[Series D]{\includegraphics[height=5cm]{images/local-1m/Local-1m-SignalingFreqStat.eps}}
...
\begin{figure}
\centering
\subfloat[Series C]{\includegraphics[height=5cm]{images/local-500cm/Robot12-16feb-1-LocalSignals.eps}}
\subfloat[Series D]{\includegraphics[height=5cm]{images/local-1m/Robot12-17feb-3-LocalSignals.eps}}
...
%%
From the above results we can see that in large group robots perform better under LSLC strategy. The local sensing of tasks prevents them to attend a far-reaching task which may be more common under global sensing strategy. However, as we have seen in Fig. \ref{fig:raw-urgencies-SC-SD}
