...
\hspace{0.25cm}
\subfloat[A binary-coded marker]{\includegraphics[width=6cm, height=4cm]{snaps/20-31412.eps}}
...
\begin{figure}
\centering
\includegraphics[width=12cm,height=20cm,angle=0]{./snaps/RILSnapshot1.eps}
